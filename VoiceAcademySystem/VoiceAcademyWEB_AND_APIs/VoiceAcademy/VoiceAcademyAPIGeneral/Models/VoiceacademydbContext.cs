...
public partial class VoiceacademydbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Chapter>(entity =>
        {
            ...
            entity.Property(e => e.ImageChapter).HasColumnName("imageChapter");
            entity.Property(e => e.LinkChapter)
                .HasMaxLength(300)
                .HasColumnName("linkChapter");
        ...
        modelBuilder.Entity<Podcastchannel>(entity =>
        {
            ...
            entity.Property(e => e.Description)
                .HasMaxLength(300)
                .HasColumnName("description");
            entity.Property(e => e.ImagePodcast).HasColumnName("imagePodcast");
